...
public class basicTicTacToe extends JComponent implements Runnable, MouseListener, KeyListener{
	...
	public static void main(String args[]) {
		...
		frame.getContentPane().add(new basicTicTacToe());
