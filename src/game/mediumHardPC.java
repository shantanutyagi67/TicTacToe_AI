...
public class mediumHardPC extends JComponent implements Runnable, MouseListener, KeyListener{
	...
	public static void main(String args[]) {
		...
		frame.getContentPane().add(new mediumHardPC());
			...
			for(int j=0;j<3;j++) {
				for(int k=0;k<3;k++) {
					if(board[j][k]=="") {
						...
						int temp = minimax(false,depth+1);
						end.clear();
						board[j][k]="";
